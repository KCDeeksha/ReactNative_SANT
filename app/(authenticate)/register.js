  ...
  return (
    <SafeAreaView style={{flex:1,backgroundColor:"white",alignItems:"center"}}>
      <View style={{marginTop:50}}>
        <Text style={{fontSize:20,textAlign:"center",fontWeight:"bold"}}>SANT</Text>
      </View>

      <KeyboardAvoidingView>
        <View style={{alignItems:"center"}}>
            <Text style={{fontSize:17,fontWeight:"bold",marginTop:12,color:"red"}}>Register your account here</Text>
        </View>
        ...
        <Ionicons style={{marginLeft:8}} name="person" size={24} color="gray" />
            ...
            onChangeText={(text) => setName(text)}
             style={{color:"gray",marginVertical:10,width:300}} placeholder='enter your Name'/>
            </View>
            ...
            style={{color:"gray",marginVertical:10,width:300}} placeholder='enter your email'/>
            </View>
            ...
            onChangeText={(text) => setPassword(text)}
             style={{color:"gray",marginVertical:10,width:300}} placeholder='enter your password'/>
            </View>
        ...
        onPress={signUpNewUser}
         style={{width:200,backgroundColor:"#fd5c63",borderRadius:6,marginLeft:"auto",marginRight:"auto",marginRight:"auto",padding:15,marginTop:50}}>
