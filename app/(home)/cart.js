  ...
  return (
    ...
    <ScrollView style={{
      ...
      <View style={{backgroundColor:"white",padding:8,marginTop:15,borderRadius:8}}>
        <Text>Delivery in <Text style={{fontWeight:"500"}}>35 - 45 mins</Text></Text>
      </View>
      ...
      <View>
        ...
        <View>
          ...
          <View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between",backgroundColor:"white",paddingVertical:10,paddingHorizontal:10}}>
            ...
            <Text>Add more instructions</Text>
            </View>
            <AntDesign name="right" size={20} color="black" />           
          </View>
          ...
          <View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between",backgroundColor:"white",paddingVertical:10,paddingHorizontal:10}}>
            <View style={{flexDirection:"row",alignItems:"center",gap:6}}>
            <FontAwesome6 name="boxes-packing" size={18} color="black" />
            <Text>Add more packing instructions</Text>
            </View>
            <AntDesign name="right" size={20} color="black" />           
          </View>
        ...
        <View>
          <View style={{
            ...
            <View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
              <Text>VOCAL FOR LOCAL</Text>
              <AntDesign name="checksquare" size={24} color="#fd5c63" />
            </View>
            <View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginTop:10}}>
              <Text style={{color:"gray"}}>Working towards Athmanirbhar Bharath</Text>
              <Text>Rs 3</Text>
            </View>
          </View>
        </View>
        ...
        <View style={{marginVertical:10}}>
            ...
            <View style={{backgroundColor:"white",borderRadius:7,padding:10,marginTop:14}}>
              ...
              <View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginVertical:8}}>
                ...
                <Text style={{fontSize:15,fontWeight:"400",color:"#505050"}}>15.00</Text>
              </View>
              <View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
